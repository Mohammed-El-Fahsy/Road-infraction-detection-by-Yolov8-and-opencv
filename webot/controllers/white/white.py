...
COLOR_THRESHOLD = 80   # seuil plus grand pour blanc
...
print("=== CONTROLEUR SUIVI LIGNE BLANCHE ===")
...
def detect_white_line(image):
    ...
    # On regarde seulement le bas de l'image
    for y in range(height // 2, height):
        for x in range(width):
            ...
            if color_diff((b, g, r), WHITE_REF) < COLOR_THRESHOLD:
                sum_x += x
                count += 1
